 ...
 * @param {string} slug slug of the camp to be retrieved
        ...
        <div>
            ...
            <div className="position-relative text-center mt-5" >
                ...
                <div className='box bg-secondary bg-opacity-75'>
                    <div className="position-absolute d-flex justify-content-between bottom-0 start-50 translate-middle-x text-white fs-2 bg-secondary bg-opacity-50 w-100">
                        ...
                        name="read-only"
                        precision={0.5}
                        value={campDetails.rating} readOnly />
                    </div>
                </div>
            </div>
            ...
            <div className='d-flex mb-3'>
                ...
                <div className='campDescMap w-50 ms-2 radius bg-secondary bg-opacity-50 h6'>
                    <MapContainer
                    className="map"
                    center={[campDetails.latitude, campDetails.longitude]}
                    zoom={20}
                    style={{height:"30vh"}}>
                        <TileLayer
                        ...
                        <Marker
                        position={[campDetails.latitude, campDetails.longitude]}
                        icon={GetIcon(50)}/>
                    </MapContainer>      
                </div>                           
            </div>
