...
export default function Search() {
    ...
    return (
        ...
        <div className='search-bar text-center'>
            ...
            <Link to={(latitude.current && longitude.current) ? `/map/${latitude.current},${longitude.current}/` : '/' }>
                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="white" className="bi bi-search ms-3" viewBox="0 0 16 16">
